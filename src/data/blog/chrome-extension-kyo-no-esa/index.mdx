...
import kyoNoEsaDemo from './kyo-no-esa-demo.gif';

<Image src={kyoNoEsaDemo} alt="今日のesaデモ" />
...
import optionsPage from './options-page.png';

<Image src="./options-page.png" alt="オプションページ" />
