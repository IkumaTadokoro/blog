...
![](../../assets/images/transfer-domain/popup.png)
...
![](../../assets/images/transfer-domain/non-support.png)
...
![](../../assets/images/transfer-domain/vercel-setting.png)

設定 > domains > ikuma-t.com を新規追加

![](../../assets/images/transfer-domain/google-domains-setting.png)
...
![](../../assets/images/transfer-domain/how-to-stop.png)

というわけで、自動更新さえ停止してしまえばお片付け終了です。

### サイトの更新

![](../../assets/images/transfer-domain/site-before.png)

サイト内に「ikuma-t.work」と書いている箇所が結構あったので、これを置換します。

![](../../assets/images/transfer-domain/site-after.png)
