...
RubyMineで[Grep](http://d.hatena.ne.jp/keyword/Grep)検索を行うには、編集 | 検索 | パス内検索 `⇧⌘ F`から「Find in Files」メニューを起動します。
...
| Directory  | [ディレクト](http://d.hatena.ne.jp/keyword/%A5%C7%A5%A3%A5%EC%A5%AF%A5%C8)リ指定ができるようになる。指定した[ディレクト](http://d.hatena.ne.jp/keyword/%A5%C7%A5%A3%A5%EC%A5%AF%A5%C8)リの範囲で検索する |
...
自分で定義しなくてもRubyMineのプリセットがいくつかあるようですが、今回は大雑把に`All Places`で[全文検索](http://d.hatena.ne.jp/keyword/%C1%B4%CA%B8%B8%A1%BA%F7)を実施し、見事欲しいソースに到達できました。
