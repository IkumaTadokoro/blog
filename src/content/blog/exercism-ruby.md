...
![](../../assets/images/exercism-ruby/exercism-ruby.png)
...
> new(size) {|index| ... } -> Array<br>長さ size の配列を生成し、各要素のインデックスを引数としてブロックを実行し、各要素の値をブロックの評価結果に設定します。<br>ブロックは要素毎に実行されるので、全要素をあるオブジェクトの複製にすることができます。<br>[Array\.new \(Ruby 3\.0\.0 リファレンスマニュアル\)](https://docs.ruby-lang.org/ja/latest/method/Array/s/new.html)
