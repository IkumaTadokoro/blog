...
![スマートフォンのメニューに「ブログを書く」メニューを追加](../../assets/images/publish-blog-from-github-issue/blog-create-button.png)

MacroDroid を使って、メニュー部分に「ブログを追加」ボタンを設置します。

Issue Template はクエリパラメータで設定できるので、その URL を登録しておきます。

![GitHub Mobile で Issue 作成画面が開く](../../assets/images/publish-blog-from-github-issue/create-issue.png)
