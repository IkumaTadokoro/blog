...
ネットで見かけたプログラミング問題を[Ruby](http://d.hatena.ne.jp/keyword/Ruby)で解いてみました。簡単なテストコードも作ったので、みなさんも是非解いてみてください。
...
3項[演算子](http://d.hatena.ne.jp/keyword/%B1%E9%BB%BB%BB%D2)を使って書いてみると以下のような感じです。
