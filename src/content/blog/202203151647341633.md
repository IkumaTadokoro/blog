...
Reactivity Transformを使った[コンポーネント](http://d.hatena.ne.jp/keyword/%A5%B3%A5%F3%A5%DD%A1%BC%A5%CD%A5%F3%A5%C8)をテストしていて、それが原因でJestが落ちるときは、`@vue/vue-jest@27.0.0-alpha.3`以上を導入しよう！
...
Vue 3.2.25からExperimentalとして追加された[コンパイラ](http://d.hatena.ne.jp/keyword/%A5%B3%A5%F3%A5%D1%A5%A4%A5%E9)ーマクロで、Vueが提供しているReactiveな値を`.value`を経由せずに取得することができるようになります。
...
これでアプリ実行時はうまくいくのですが、[ユニットテスト](http://d.hatena.ne.jp/keyword/%A5%E6%A5%CB%A5%C3%A5%C8%A5%C6%A5%B9%A5%C8)に使用しているJestではWebpackは関係ないため、この構文の解釈ができずにエラーになります。
...
Reactivity Transformのみならず、Vueの仕様については[GitHub](http://d.hatena.ne.jp/keyword/GitHub) Discussionsにて議論されています。
