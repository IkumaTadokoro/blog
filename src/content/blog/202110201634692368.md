...
久しぶりに[コマンドライン](http://d.hatena.ne.jp/keyword/%A5%B3%A5%DE%A5%F3%A5%C9%A5%E9%A5%A4%A5%F3)から`git init`したら、以下のようなメッセージが表示されました。
...
この状態で、`git init`をしてみると、ブランチが`main`で作成されていました。<img alt="f:id:ikmbear:20211020101207p:plain" src="https://cdn-ak.f.st-hatena.com/images/fotolife/i/ikmbear/20211020/20211020101207.png" title="" height="25" width="337" />
